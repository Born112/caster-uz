    ...
    <main className="min-h-screen bg-[#0A0E1A] text-white">
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="flex items-center gap-2 text-sm text-[#8B92A8] mb-4 mt-4">
          ...
          <span>/</span>
          <Link href="/admin/teams" className="hover:text-white transition-colors">Jamoalar</Link>
          <span>/</span>
          <span className="text-white">Yangi</span>
        </div>

        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2"><span className="text-[#FF6B35]">➕</span> Yangi jamoa qo&apos;shish</h1>
          <p className="text-[#8B92A8]">Klub ma&apos;lumotlarini to&apos;ldiring</p>
        </div>
