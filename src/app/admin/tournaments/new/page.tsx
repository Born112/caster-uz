  ...
  return (
    <main className="min-h-screen bg-[#0A0E1A] text-white">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2"><span className="text-[#FF6B35]">➕</span> Yangi turnir qo&apos;shish</h1>
          <p className="text-[#8B92A8]">Turnir ma&apos;lumotlarini to&apos;ldiring</p>
        </div>
