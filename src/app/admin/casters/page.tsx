...
import CastersTable from "./CastersTable";
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">
              <span className="text-[#FF6B35]">🎙️</span> Casterlarni boshqarish
            </h1>
            <p className="text-[#8B92A8]">
              Jami {casters?.length || 0} ta caster
            </p>
          </div>
