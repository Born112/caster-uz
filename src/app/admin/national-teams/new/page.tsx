  ...
  return (
    <main className="min-h-screen bg-[#0A0E1A] text-white">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2"><span className="text-[#FF6B35]">➕</span> Yangi terma jamoa</h1>
          <p className="text-[#8B92A8]">Milliy yoki hududiy terma jamoa qo&apos;shing</p>
        </div>

        <NationalTeamForm mode="create" />
      </div>
    </main>
  );
}
